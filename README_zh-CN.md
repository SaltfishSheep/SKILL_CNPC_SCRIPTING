...
安装本 Skill 前，需先配置以下 MCP 服务：

1. **[AI-MCP-NativeMinecraftAccess](https://github.com/SaltfishSheep/AI-MCP-NativeMinecraftAccess)** — 提供 Minecraft 混淆类名 / 方法名 / 字段名查询
2. **[AI-MCP-CNPCAPIAccess](https://github.com/SaltfishSheep/AI-MCP-CNPCAPIAccess)** — 提供 CNPC JavaDoc API 搜索和类继承层级查询

具体安装步骤请参阅各仓库的 README。
